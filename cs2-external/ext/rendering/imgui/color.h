...
namespace colors {
    inline ImVec4 general_color = ImColor(218, 112, 214, 255); // theme color
    inline ImVec4 main_color = ImColor(16, 16, 16, 255);
    inline ImVec4 lite_color = ImColor(25, 25, 25, 255);
    inline ImVec4 gray_color = ImColor(43, 43, 43, 255);
    inline ImVec4 Tab_Child = ImColor(15, 15, 15, 150);
    inline ImVec4 Tab_Border = ImColor(26, 26, 26, 255);

    inline ImVec4 Tab_Selected = ImColor(255, 255, 255, 255);
    ...
    inline ImVec4 Checkbox_Active = ImColor(218, 112, 214, 255); // checkbox active color

    inline ImVec4 Car_Slider = ImColor(218, 112, 214, 255); // slider color
    inline ImVec4 Car_Slider_Hovered = ImColor(217, 158, 215, 255);
    inline ImVec4 Car_Slider_Active = ImColor(217, 158, 215, 255);
