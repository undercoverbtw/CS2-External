...
namespace offsets
{
    ...
    inline constexpr std::ptrdiff_t dwLocalPlayerPawn = 0x16B9388;
    ...
    inline constexpr std::ptrdiff_t m_iPawnHealth = 0x7E0;
    inline constexpr std::ptrdiff_t Pos = 0x1224;
   ...
   inline constexpr std::ptrdiff_t m_flDetectedByEnemySensorTime = 0x13DC; // GameTime_t
